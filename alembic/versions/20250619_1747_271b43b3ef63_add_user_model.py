...
Revision ID: 271b43b3ef63
Revises: d5aceb9f23b1
Create Date: 2025-06-19 17:47:50.333053+00:00
...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_user_last_activity", "user", ["last_activity_at"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_user_last_activity_at"), "user", ["last_activity_at"], unique=False
    )
...
def downgrade() -> None:
    ...
    op.drop_index(op.f("ix_user_last_activity_at"), table_name="user")
